...
[Fun with Logistic Regression](http://introtopython.org/): implementation of a logistic regression model using NumPy, with all of the math details on the model included.  
...
[Learn Data Science](https://github.com/nborwankar/LearnDataScience): Notebooks and explanations on linear regression, logistic regression, random forests, and k-means clustering.